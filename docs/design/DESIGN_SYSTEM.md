# Book Maker Design System

## 1. 목적

이 문서는 Book Maker의 실제 구현에 사용할 디자인 시스템 기준을 정의한다.
...
- 영어는 브랜드명(Book Maker)과 불가피한 기술 용어에만 사용
...
- 히어로 패널: 실제 Book Maker 기록 예시 표시 (Korean content)
